...
class AnthropicProvider(BaseLLMProvider):
    ...
    def __init__(self, api_key: str | None = None) -> None:
        ...
        Args:
            api_key: Anthropic API key. If not provided, uses ANTHROPIC_API_KEY from env.
        """
    ...
    async def complete(
        ...
        **kwargs: Any,
        ...
        Note: Anthropic requires system message to be passed separately.
        """
    ...
    async def complete_json(
        ...
        **kwargs: Any,
        ...
        Anthropic doesn't have a native JSON mode, so we prompt for it.
        """
